...
function findUserByUsername(usersArray, username) {
  return usersArray.find(function(obj){
    return obj.username === username ? obj : false;
  });
}
...
Write a function called `removeUser` 
  ...
  The function should remove the object from 
  the array. If the object is not found, 
  return undefined. 
...
function removeUser(usersArray, username) {
  ...
  return i != -1 ? usersArray.splice(i,1)[0] : undefined;
}